...
<script lang="ts">
  ...
  const documentationLinks: Links = [
    { title: '开始使用', href: 'https://mermaid.js.org/intro/getting-started.html' },
    { title: '教程', href: 'https://mermaid.js.org/ecosystem/tutorials.html' },
    {
      title: '集成',
...
<div class="navbar z-50 bg-primary p-0 shadow-lg">
  <div class="mx-2 flex flex-1 gap-2 px-2">
    <a href="/"><img class="size-6" src="./favicon.svg" alt="Mermaid 在线编辑器" /></a>
    <div
      id="switcher"
  ...
  <div class="hidden w-full lg:flex lg:w-auto lg:items-center" id="menu">
    ...
    <ul class="items-center justify-between pt-4 text-base lg:flex lg:pt-0">
      ...
      <li>
        <DropdownNavMenu label="文档" links={documentationLinks} />
      </li>
